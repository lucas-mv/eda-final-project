...
```{r}
plot1 <- ggplot(wines, aes(x = quality, y = fixed_acidity)) + geom_point(fill = I('purple'), color = 'black', shape = 21) + stat_smooth(method = 'lm')
...
```{r}
plot1 <- ggplot(wines, aes(x = quality, y = volatile_acidity)) + geom_point(fill = I('purple'), color = 'black', shape = 21) + stat_smooth(method = 'lm')
...
```{r}
plot1 <- ggplot(wines, aes(x = quality, y = citric_acid)) + geom_point(fill = I('purple'), color = 'black', shape = 21) + stat_smooth(method = 'lm')
...
```{r}
plot1 <- ggplot(wines, aes(x = quality, y = residual_sugar)) + geom_point(fill = I('purple'), color = 'black', shape = 21) + stat_smooth(method = 'lm')
...
```{r}
plot1 <- ggplot(wines, aes(x = quality, y = chlorides)) + geom_point(fill = I('purple'), color = 'black', shape = 21) + stat_smooth(method = 'lm')
...
```{r}
plot1 <- ggplot(wines, aes(x = quality, y = free_sulfur_dioxide)) + geom_point(fill = I('purple'), color = 'black', shape = 21) + stat_smooth(method = 'lm')
...
```{r}
plot1 <- ggplot(wines, aes(x = quality, y = total_sulfur_dioxide)) + geom_point(fill = I('purple'), color = 'black', shape = 21) + stat_smooth(method = 'lm')
...
```{r}
plot1 <- ggplot(wines, aes(x = quality, y = density)) + geom_point(fill = I('purple'), color = 'black', shape = 21) + stat_smooth(method = 'lm')
...
```{r}
plot1 <- ggplot(wines, aes(x = quality, y = pH)) + geom_point(fill = I('purple'), color = 'black', shape = 21) + stat_smooth(method = 'lm')
...
```{r}
plot1 <- ggplot(wines, aes(x = quality, y = sulphates)) + geom_point(fill = I('purple'), color = 'black', shape = 21) + stat_smooth(method = 'lm')
...
```{r}
plot1 <- ggplot(wines, aes(x = quality, y = alcohol)) + geom_point(fill = I('purple'), color = 'black', shape = 21) + stat_smooth(method = 'lm')
